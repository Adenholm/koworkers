    ...
    public ArrayList<Point> getPossibleMoves(ArrayList<Point> boardPositions) {
        ...
        for(Point point: currentList){
            for(Point surroundPoint: getSurroundingCoordinates(point)) {
                ...
                if(!surroundPoint.equals(queenPoint) && boardPositions.contains(surroundPoint) && !possibleMoves.contains(point) && !boardPositions.contains(point) && !pieceIsStuck(boardPositions,point)){
